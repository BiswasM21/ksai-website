...
const serviceLinks = [
  ...
  { href: "/services#app-building", label: "App Building" },
...
const socialLinks = [
  ...
  { href: "https://github.com/kalinga-sovereign-ai", label: "GitHub", Icon: GitHubIcon },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-[var(--color-muted)] text-sm leading-relaxed max-w-sm">
              Building intelligent solutions that empower businesses across India and the Global South to harness the power of artificial intelligence.
            </p>
          </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-[var(--color-surface-2)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-muted)] hover:text-[var(--color-accent)] hover:border-[var(--color-accent)] transition-all duration-200"
                >
                  <social.Icon />
                </a>
              ))}
